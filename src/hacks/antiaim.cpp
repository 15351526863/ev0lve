Rework the damage indicator's style(in bullet_tracers.cpp), with this lua code(1:1 the style, such like fortnite damage):
...
local function var_0_5(arg_1_0)
	local var_1_0 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"

	return (string.gsub(arg_1_0, "[^" .. var_1_0 .. "=]", ""):gsub(".", function(arg_2_0)
		if arg_2_0 == "=" then
			return ""
		end

		local var_2_0 = ""
		local var_2_1 = var_1_0:find(arg_2_0) - 1

		for iter_2_0 = 6, 1, -1 do
...
for iter_0_0 = 1, #var_0_1 do
	var_0_2[iter_0_0 - 1] = renderer.load_png(var_0_5(var_0_1[iter_0_0]), var_0_3, var_0_4)
end
...
local var_0_7, var_0_8, var_0_9, var_0_10 = ui.get(var_0_6.head_color)
local var_0_11, var_0_12, var_0_13, var_0_14 = ui.get(var_0_6.body_color)
local var_0_15 = ui.get(var_0_6.timeout) * 0.1
local var_0_16 = ui.get(var_0_6.scale) * 0.005
local var_0_17 = {}
local var_0_18 = {
	Player = function(arg_4_0)
		return entity.get_local_player() == arg_4_0
	end,
	Teammates = function(arg_5_0)
		return not entity.is_enemy(arg_5_0)
	end,
	Enemies = function(arg_6_0)
		return entity.is_enemy(arg_6_0)
	end
}
...
local function var_0_19(arg_7_0, arg_7_1, arg_7_2)
	for iter_7_0, iter_7_1 in pairs(arg_7_0) do
		if iter_7_1 ~= arg_7_2 then
			ui.set_visible(iter_7_1, arg_7_1)
		end
	end
end

local function var_0_20(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4, arg_8_5, arg_8_6, arg_8_7)
	renderer.texture(var_0_2[arg_8_0], arg_8_1 - arg_8_3 * var_0_3 / 2, arg_8_2 - arg_8_3 * var_0_4 / 2, var_0_3 * arg_8_3, var_0_4 * arg_8_3, arg_8_4, arg_8_5, arg_8_6, arg_8_7, "f")
end

local function var_0_21(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5, arg_9_6, arg_9_7, arg_9_8)
	local var_9_0 = var_0_0.quart_in(arg_9_6 / var_0_15, 0, 1, 1)
	local var_9_1 = arg_9_5 * (1 - var_9_0)
	local var_9_2 = var_9_0
	local var_9_3 = string.format("%d", arg_9_8)

	for iter_9_0 = 1, string.len(var_9_3) do
		local var_9_4 = tonumber(string.sub(var_9_3, iter_9_0, iter_9_0))
		local var_9_5 = var_0_0.elastic_out(arg_9_6, 0, 1, 1 + iter_9_0 * 0.25) - var_9_0

		var_0_20(var_9_4, arg_9_0 + iter_9_0 * (var_0_3 * arg_9_7), arg_9_1 - var_9_2 * 256, arg_9_7 * var_9_5, arg_9_2, arg_9_3, arg_9_4, var_9_1)
	end
end

local function var_0_22(arg_10_0)
	local var_10_0 = client.userid_to_entindex(arg_10_0.attacker)

	for iter_10_0, iter_10_1 in ipairs(ui.get(var_0_6.mode)) do
		if var_0_18[iter_10_1](var_10_0) then
			local var_10_1 = client.userid_to_entindex(arg_10_0.userid)
			local var_10_2, var_10_3, var_10_4 = entity.hitbox_position(var_10_1, 0)

			if var_10_2 ~= nil then
				if var_0_17[var_10_1] then
					var_0_17[var_10_1] = {
						var_0_17[var_10_1][1] + arg_10_0.dmg_health,
						globals.realtime(),
						var_10_2,
						var_10_3,
						var_10_4,
...
local function var_0_23()
	local var_11_0 = globals.realtime()

	for iter_11_0, iter_11_1 in pairs(var_0_17) do
		if iter_11_1 then
			local var_11_1, var_11_2 = renderer.world_to_screen(iter_11_1[3], iter_11_1[4], iter_11_1[5])

			if var_11_1 ~= nil then
				local var_11_3 = var_0_11
				local var_11_4 = var_0_12
				local var_11_5 = var_0_13
				local var_11_6 = var_0_14

				if iter_11_1[6] then
					var_11_3, var_11_4, var_11_5, var_11_6 = var_0_7, var_0_8, var_0_9, var_0_10
				end

				if var_11_0 - iter_11_1[2] >= var_0_15 then
					var_0_17[iter_11_0] = nil
				else
					var_0_21(var_11_1, var_11_2, var_11_3, var_11_4, var_11_5, var_11_6, var_11_0 - iter_11_1[2], var_0_16, iter_11_1[1])
				end
			end
		end
	end
...
local function var_0_24()
	local var_12_0 = ui.get(var_0_6.enabled)
	local var_12_1 = var_12_0 and client.set_event_callback or client.unset_event_callback

	var_12_1("player_hurt", var_0_22)
	var_12_1("paint", var_0_23)
	var_0_19(var_0_6, var_12_0, var_0_6.enabled)

	var_0_17 = {}
end

ui.set_callback(var_0_6.enabled, var_0_24)
var_0_24()
ui.set_callback(var_0_6.head_color, function()
	var_0_7, var_0_8, var_0_9, var_0_10 = ui.get(var_0_6.head_color)
end)
ui.set_callback(var_0_6.body_color, function()
	var_0_11, var_0_12, var_0_13, var_0_14 = ui.get(var_0_6.body_color)
end)
ui.set_callback(var_0_6.timeout, function()
	var_0_15 = ui.get(var_0_6.timeout) * 0.1
end)
ui.set_callback(var_0_6.scale, function()
	var_0_16 = ui.get(var_0_6.scale) * 0.005
end)