...
void hook_manager_t::init()
{
...
#endif
#ifndef NDEBUG
	//create_hook(run_command_server, game->server.at(functions::server::run_command),
	...
	/* recv_proxies */
	//create_hook(layer_sequence, reinterpret_cast<recv_prop *>(game->client.at(0x5350C5C),
	//			&hooks::recv_proxies::layer_sequence);
	...
	/* miscellaneous */
	//create_hook(get_module_handle_ex_a, FIND_EXPORT("kernel32.dll", "GetModuleHandleExA"),
