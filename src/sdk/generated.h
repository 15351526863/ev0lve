...
namespace globals
{
	...
	constexpr uint32_t patch_send_move_cmds = 0xdd184;
...
namespace functions
{
	...
	*/
	...
	namespace server
	{
		constexpr uint32_t setup_bones = 0x000000; // MISSING
		constexpr uint32_t get_entity = 0x000000; // MISSING
	}
	...
	{
	constexpr uint32_t present = 0x6a120;
	constexpr uint32_t reset = 0x6a4a0;
		constexpr uint32_t length_disasm = 0x76bd0;
	}
